...
private val ADVICE_WINDOW_FRAGMENT = AdviceWindowFragment().javaClass.name
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            when (item.itemId) {
                R.id.advice -> {
                    ...
                    fragment = if (savedInstanceState != null) supportFragmentManager.getFragment(
                        savedInstanceState,
                        ADVICE_WINDOW_FRAGMENT
                    ) else AdviceWindowFragment()
                }
                R.id.about -> {
        ...
        bottomNavigationView.selectedItemId =
            savedInstanceState?.getInt(LAST_SELECTED_ITEM) ?: R.id.advice
